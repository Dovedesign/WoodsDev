...
<div class="band" id="middle">
	<div class="container">
		...
		<div class="three columns text-btn icon-btn mobile">
			<a href="sms:1-512-878-2424" class="btn" title="Text Us"><span class="icon" style="background-image: url(<?php bloginfo('stylesheet_directory'); ?>/images/btn-icon_text.svg);">Text Us</span></a>
		</div>
		<div class="three columns text-btn textus-btn icon-btn non-mobile">
			<a href="https://app.textus.biz/widget/1/F3GzPdp5gRWPoSAaHBlxwnW7WdU/contents" data-fancybox-type="iframe" class="btn inline" title="Text Us"><span class="icon" style="background-image: url(<?php bloginfo('stylesheet_directory'); ?>/images/btn-icon_text.svg);">Text Us</span></a>
		</div>
		<?php /*?>
...
<div class="band" id="look">
	<div class="container">
		<div class="sixteen columns">
			...
			<?php if(get_field('video_box_video_url')) : ?><div class="video"><iframe src="//player.vimeo.com/video/102064186" width="900" height="506" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div><?php else: ?><?php endif; ?>
...
<div style="text-align:center">
    ...
    <script type="text/javascript">
        candid.init({ id: 'ad9f82a8-8501-45fd-8ef1-80dd4515178d' });
    </script>
</div>
<!-- END: Candid Widget -->
