    ...
    <div class="pps-tab-container">
        	...
        	<fieldset class="pps-option-group pps-option-radio">
                ...
                <div class="pps-option-content pps-clearfix">
                	<div class="pps-option-item pps-boxs-3">
                        <input id="pps-where-open-link-true" name="pps_options[where_open_link]" type="radio" value="_blank" <?php checked('_blank', $options['where_open_link']); ?> />
						<label for="pps-where-open-link-true"><?php _e( 'New Tab', 'PPS' ); ?></label>
                    </div><!--.pps-option-item-->
                	<div class="pps-option-item pps-boxs-3">
                        <input id="pps-where-open-link-false" name="pps_options[where_open_link]" type="radio" value="_self" <?php checked('_self', $options['where_open_link']); ?> />
        ...
        <div id="pps-tab4" class="pps-tab-content">
            ...
            <fieldset class="pps-option-group pps-option-text">
                ...
                <div class="pps-option-content pps-clearfix">
                	<div class="pps-option-item pps-input-s">
                       ...
                       <span class="pps-option-info"><?php _e( '(px). Add the width of the embeds', 'PPS' ); ?></span>
                    </div><!--.pps-option-item-->
            ...
            <fieldset class="pps-option-group pps-option-radio">
                ...
                <div class="pps-option-content pps-clearfix">
                	<div class="pps-option-item pps-boxs-6">
                        <input id="pps-use-wp-editor-true" name="pps_options[use_wp_editor]" type="radio" value="true" <?php checked('true', $options['use_wp_editor']); ?> />
						<label for="pps-use-wp-editor-true"><?php _e( 'Yes', 'PPS' ); ?></label>
                    </div><!--.pps-option-item-->
                	<div class="pps-option-item pps-boxs-6">
                        <input id="pps-use-wp-editor-false" name="pps_options[use_wp_editor]" type="radio" value="false" <?php checked('false', $options['use_wp_editor']); ?> />
